  ...
  <main class="login">
    <section class="forms">
      <form class="login" @submit.prevent="login">
        <div
          class="min-w-screen min-h-screen bg-blue-100 bg-opacity-30 flex items-center justify-center pb-24 px-5 py-5">
            ...
            <div class="md:flex w-full">
              ...
              <div class="w-full md:w-1/2 py-10 px-5 md:px-10 ">
                <div class="text-center mb-10">
                  ...
                  <h1 class="font-medium text-xl text-gray-700">We are <span class="text-indigo-600">Happy</span>
                    to see you back</h1>
                ...
                <div>
                  ...
                  <div class="flex -mx-3" method="POST">
                    <div class="w-full px-3 ">
                      ...
                      <div class="flex">
                        ...
                        <input type="password" placeholder="Password" v-model="login_form.password" id="password"
                  ...
                  <div class="flex items-center justify-between mt-3">
                    ...
                    <a href="/register"
                      class="text-xs font-semibold text-gray-500 uppercase dark:text-gray-400 hover:underline">CREATE
                      AN ACCOUNT</a>
                    <span class="w-1/5 border-b dark:border-gray-600 md:w-1/4"></span>
                  </div>
                </div>
