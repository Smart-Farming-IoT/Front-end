<template>
  <form @submit="handleSubmit">
    <div
      class="min-w-screen min-h-screen bg-blue-100 bg-opacity-30 flex items-center justify-center px-5 py-5"
    >
      <div
        ...
        <div class="md:flex w-full">
          ...
          <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
            <div class="text-center mb-10">
              ...
              <h1 class="font-medium text-xl text-gray-700">
                Join <span class="text-indigo-600">IOT</span> Smart farming
              </h1>
            ...
            <div>
              ...
              <div class="flex items-center justify-between mt-3">
                ...
                <a
                  href="/login"
                  class="text-xs font-semibold text-gray-500 uppercase dark:text-gray-400 hover:underline"
