              ...
              <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <div>
                  ...
                  <div class="flex -mx-3" method="POST">
                    <div class="w-full px-3 ">
                      ...
                      <div class="flex">
                        ...
                        <input type="password" placeholder="Password" v-model="register_form.password" id="password"
                  ...
                  <div class="flex items-center justify-between mt-3">
                    ...
                    <a href="/login"
                      class="text-xs font-semibold text-gray-500 uppercase dark:text-gray-400 hover:underline">Do
