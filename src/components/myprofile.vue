  ...
  <div class="h-screen bg-blue-100 bg-opacity-30  flex flex-wrap items-center  justify-center  ">
    <div
      ...
      <div class="flex justify-center px-5  -mt-12">
        <img class="h-32 w-32 bg-white p-2 rounded-full   " src="@/assets/Team/074.jpg" alt="" />

      </div>
      <div class=" ">
        <div class="text-center px-14">
          <h2 class="text-gray-800 text-3xl font-bold">P M</h2>
          <a class="text-gray-400 mt-2 hover:text-blue-500" href="https://www.instagram.com/immohitdhiman/"
            target="BLANK()">@LucK เดี่ยวแก้</a>
